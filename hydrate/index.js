...
const stButtonCss = "/*!@:host*/.sc-st-button-h{align-items:center;background-color:darkblue;border-radius:4px;color:white;display:flex;flex:0 0 auto;font-family:Arial, Helvetica, sans-serif;font-weight:lighter;justify-content:center;line-height:normal;padding:0.25rem;text-align:center}";
...
const stCompCss = "/*!@:host*/.sc-st-comp-h{display:block}";
...
const stHeroCss = "/*!@:host*/.sc-st-hero-h{display:block}";
